if (Meteor.isClient) {
	Testing = {
		...
		createMessageServer: function() {
			...
			Debug.messaging('createMessageServer', Messages.find().fetch());
		},
		createMessageServerCallback: function() {
			Meteor.call('addMessage', 'Message text', function(e, r) {
				Debug.messaging('createMessageServerCallback', r);
			});
		},
		createMessageClient: function() {
			...
			Debug.messaging('createMessageClient', Messages.insert(message));
		},

...
var sellHandler = function() {
	function rendTitle() {
		this.render('addTitle', {to: 'sellYield'});
	}

	function rendInfo() {
		this.render('addInfo', {to: 'sellYield'});
	}

	function rendPre() {
		this.render('postPreview', {to: 'sellYield'});
	}
	return {
		title: rendTitle,
		info: rendInfo,
...
Router.map(function() {
	...
	this.route('offers', {
		...
		data: function() {
			var offers = distinct(Offers.find({
	...
	this.route('offers', {
		...
		data: function() {
			var offer = Offers.findOne({postId: this.params.id, buyerId: this.params.pid});
